...
- Color operations, i.e., distort color channels without impacting the locations of the bounding boxes
- Geometric operations, i.e., geometrically distort the image, which correspondingly alters the location and size of the bounding box annotations
- Bounding box operations, i.e., only distort the pixel content contained within the bounding box annotations.
